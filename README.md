...
> 📚 **Docs:** [USAGE.md](USAGE.md) — how to use it (what to say to your coach) · [SETUP.md](SETUP.md) — install · [CONFIG-REFERENCE.md](CONFIG-REFERENCE.md) — the Config "brain" · [SECURITY.md](SECURITY.md) — keep your data safe · [CONTRIBUTING.md](CONTRIBUTING.md) — fork / maintainer notes
